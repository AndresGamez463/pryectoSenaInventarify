    ...
    <div>
      ...
      <div>
        ...
        <input
          ...
          onChange={handleInputChange}
        />
        <button onClick={handleCreate}>Add Proveedor</button>
      </div>
      <ul>
        {proveedores.map(proveedor => (
          <li key={proveedor.id}>
            ...
            />
            <button onClick={() => handleUpdate(proveedor.id)}>Update</button>
            <button onClick={() => handleDelete(proveedor.id)}>Delete</button>
          </li>
        ))}
      </ul>
    </div>
