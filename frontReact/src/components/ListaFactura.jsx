    ...
    <div>
      ...
      <div>
        ...
        <input
          ...
          onChange={handleInputChange}
        />
        <button onClick={handleCreate}>Add Factura</button>
      </div>
      <ul>
        {facturas.map(factura => (
          <li key={factura.id}>
            ...
            />
            <button onClick={() => handleUpdate(factura.id)}>Update</button>
            <button onClick={() => handleDelete(factura.id)}>Delete</button>
          </li>
        ))}
      </ul>
    </div>
