    ...
    <div>
      ...
      <div>
        ...
        <input
          ...
          onChange={handleInputChange}
        />
        <button onClick={handleCreate}>Add Departamento</button>
      </div>
      <ul>
        {departamentos.map(departamento => (
          <li key={departamento.id}>
            ...
            />
            <button onClick={() => handleUpdate(departamento.id)}>Update</button>
            <button onClick={() => handleDelete(departamento.id)}>Delete</button>
          </li>
        ))}
      </ul>
    </div>
